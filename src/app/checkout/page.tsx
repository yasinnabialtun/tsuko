                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input required type="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">Telefon</label>
                                        <input required type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="5XX XXX XX XX" className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                    </div>
                                </div>
                            </section>
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input required type="text" name="firstName" value={formData.firstName} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">Soyad</label>
                                            <input required type="text" name="lastName" value={formData.lastName} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">Tam Adres</label>
                                        <textarea required name="address" rows={3} value={formData.address} onChange={handleChange} placeholder="Mahalle, Sokak, No/Daire..." className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 resize-none placeholder:text-black/30" />
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">İl</label>
                                            <input required type="text" name="city" value={formData.city} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">İlçe</label>
                                            <input required type="text" name="district" value={formData.district} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-1">Posta Kodu</label>
                                            <input type="text" name="zipCode" value={formData.zipCode} onChange={handleChange} className="w-full px-6 py-4 rounded-xl border-4 border-black bg-white focus:bg-[var(--color-yellow)]/10 text-black font-bold outline-none transition-all focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:-translate-y-1 placeholder:text-black/30" />
                                        </div>
                                    </div>
                                </div>
                            </section>
